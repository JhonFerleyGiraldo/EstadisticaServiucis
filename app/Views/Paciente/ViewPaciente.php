...
<head>
  ...
  <title>Estadística | Pacientes</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Menú Pacientes</h1>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <?php if($_SESSION["perfilUsuario"] == "ENFERMERIA" || $_SESSION["perfilUsuario"]=="ADMINISTRADOR"): ?>
              <a href="<?=BASEURL?>Paciente/GetVistaSincronizarPaciente"><button type="button" id="sincronizarPac" class="btn btn-block btn-primary"><img src="<?=BASEURL?>app/img/update1.png"></img> Sincronizar nuevo paciente</button></a>
            <?php endif; ?>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">Listado pacientes hosvital sincronizados</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($dato["estado"]=="ABIERTO"): ?>
                        <a href="<?=BASEURL?>Paciente/GetVistaActualizarPaciente&documento=<?=$dato['documento'];?>&numIngreso=<?=$dato["ingreso"];?>"><button type="button" class="btn btn-block btn-primary ">Ingreso</button></a>
                      <?php else: ?>
                        <a href="<?=BASEURL?>Paciente/GetVistaActualizarPaciente&documento=<?=$dato['documento'];?>&numIngreso=<?=$dato["ingreso"];?>"><button type="button"  class="btn btn-block btn-success ">Consultar</button></a>
                      <?php endif; ?>    
                    </td>
                  </tr>
                  <?php endforeach; ?>
