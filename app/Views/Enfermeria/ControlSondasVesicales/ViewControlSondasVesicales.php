...
<head>
  ...
  <title>Estadística | Sondas Vesicales</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Menú Control Sondas Vesicales</h1>
    ...
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">Listado pacientes con sonda vesical</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($dato["estado"]=="ABIERTO"): ?>
                        <a href="<?=BASEURL?>ControlSondasVesicales/GetVistaControlSondasVesicalesXpaciente&documento=<?=$dato['documento'];?>&numIngreso=<?=$dato["ingreso"];?>"><button type="button" class="btn btn-block btn-primary ">Abrir</button></a>
                      <?php else: ?>
                        <a href="<?=BASEURL?>ControlSondasVesicales/GetVistaControlSondasVesicalesXpaciente&documento=<?=$dato['documento'];?>&numIngreso=<?=$dato["ingreso"];?>"><button type="button"  class="btn btn-block btn-success ">Consultar</button></a>
                      <?php endif; ?>    
                    </td>
                  </tr>
                  <?php endforeach; ?>
