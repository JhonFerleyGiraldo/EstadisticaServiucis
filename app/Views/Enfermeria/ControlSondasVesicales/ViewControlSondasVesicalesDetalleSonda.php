...
<head>
  ...
  <title>Estadística | Detalle Sonda Vesical</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Sonda Vesical</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form">
                <div class="card-body">
					...
					<div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="numSonda" disabled>
                            </div>
                        </div> 
                    </div>
            ...
            <div class="form-group">
              <div class="row">       
                ...
                <div class="col-md-2">
                  <label for="diasSonda">Días Sonda</label>
                </div>
                <div class="col-md-2">
                  <input type="text" class="form-control" id="diasSonda" disabled>
                </div>
              </div> 
            </div>
                ...
                <div class="card-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button id="botonRetirarSonda" type="button" onclick="RetirarSonda();" class="btn btn-primary"> Retirar</button>
                            </div> 
                        </div> 
                </div>
              </form>
...
$(document).ready(function(){
    ...
    if(codigoSonda!=0 && codigoIngreso!=0){

      var datosSonda=ConsultarDatosSonda(codigoSonda,codigoIngreso);

        //recorremos la repuesta
        $(datosSonda).each(function(i, v){ // indice, valor
            ...
            $("#numSonda").val(v.numeroSonda);
            $("#lugarProcedimiento").val(v.lugar);
            if(v.enfermero==null){
              $("#enfermero").val("N/A");
            }else{
            ...
            //es porque la sonda ya fue retirada, llenamos los campos que faltan y los bloqueamps
...
function ConsultarDatosSonda(codSonda,codIngreso){
  ...
  $.ajax({
            ...
            url: '../ControlSondasVesicales/GetConsultarDatosCateter',//llamado a metodo
            data:{"codSonda":codSonda,"codIngreso":codIngreso}, //parametros
            ...
            error: function (error) {
              //mensajes de error
                $(document).Toasts('create', {
                    ...
                    title: 'Validación',
                    subtitle: 'Error',
                    body: 'Error consultando datos de sonda vesical (error llamando consulta).',
                    icon:"fas fa-exclamation-circle",
                    autohide:true,
                    delay:5000
                });  
...
function RetirarSonda(){

    if(ValidarCampos()){

      GuardarRetiroSonda(codigoSonda,codigoIngreso,fechaRetiro,motivoRetiro,cultivo,reporte);
