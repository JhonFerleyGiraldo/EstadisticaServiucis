  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Menú Registro Dispositivos</h1>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            <?php if($_SESSION["perfilUsuario"] == "ENFERMERIA" || $_SESSION["perfilUsuario"]=="ADMINISTRADOR"): ?>
              <a href="<?=BASEURL?>RegistroDispositivos/GetVistaNuevoRegistroDispositivos"><button type="button" id="sincronizarPac" class="btn btn-block btn-primary"><img src="<?=BASEURL?>app/img/agregar.png"></img>  Nuevo Registro</button></a>
            <?php endif; ?>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">Listado Registro Dispositivos</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php foreach($registroDispositivos as $dato): ?>
                  <tr>
                    <td><?=$dato["fecha"];?></td>
                    <td><?=$dato["numeroPacientes"];?></td>
                    <td><?=$dato["cvc"];?></td>
                    <td><?=$dato["sv"];?></td>
                    <td><?=$dato["vm"];?></td>
                    <td><?=$dato["cvp"];?></td>
                    <td><?=$dato["enfermero"];?></td>
                  </tr>
                  <?php endforeach; ?>
                </tfoot>
              </table>
