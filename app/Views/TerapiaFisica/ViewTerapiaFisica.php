...
<head>
  ...
  <title>Estadística | Terapia Física</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Menú terapia física</h1>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($dato["estado"]=="ABIERTO"): ?>
                        <a href="<?=BASEURL?>EstadisticaTerapiaFisica/GetVistaEstadisticaXpaciente&documento=<?=$dato['documento'];?>&numIngreso=<?=$dato["ingreso"];?>"><button type="button" class="btn btn-block btn-primary ">Abrir</button></a>
                      <?php elseif($dato["estado"]=="CERRADO"): ?>
                        <a href="<?=BASEURL?>EstadisticaTerapiaFisica/GetVistaEstadisticaXpaciente&documento=<?=$dato['documento'];?>&numIngreso=<?=$dato["ingreso"];?>"><button type="button"  class="btn btn-block btn-success ">Consultar</button></a>
                    <?php elseif($dato["estado"]==NULL): ?>
                        <?php if($_SESSION["perfilUsuario"]=="TERAPIA" || $_SESSION["perfilUsuario"]=="TERAPIAFISICA" || $_SESSION["perfilUsuario"]=="ADMINISTRADOR"): ?>
                          <a href="<?=BASEURL?>EstadisticaTerapiaFisica/GetVistaAgregarNuevaEstadistica&documento=<?=$dato['documento'];?>&numIngreso=<?=$dato["ingreso"];?>"><button type="button"  class="btn btn-block btn btn-info ">Nueva Esta.</button></a>
                        <?php else: ?>
